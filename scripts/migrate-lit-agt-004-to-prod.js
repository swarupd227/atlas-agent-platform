 ...
 * Saves:  scripts/lit-agt-004-prod-ids.json
 */
...
async function main() {
  ...
  // ── SAVE IDs ──────────────────────────────────────────────────────────────────
  writeFileSync("scripts/lit-agt-004-prod-ids.json", JSON.stringify(ids, null, 2));

  console.log("\n════════════════════════════════════════════════════════════════════");
  console.log("  ✅  LIT-AGT-004 — PRODUCTION MIGRATION — COMPLETE");
  console.log("════════════════════════════════════════════════════════════════════");
  console.log(`\n  Agent:           ${ids.agentId}`);
  ...
  console.log(`\n  Prod IDs saved → scripts/lit-agt-004-prod-ids.json\n`);
}
