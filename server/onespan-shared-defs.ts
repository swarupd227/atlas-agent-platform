...
KEY INSIGHTS:
• [Insight 1 with specific numbers — framed as an observation, not a criticism]
• [Insight 2 with specific numbers]
• [Insight 3 with specific numbers — reference the active TXN-2026-00847 correction as a positive example of proactive intervention]

PERFORMANCE DRIVER ANALYSIS:
[1-2 sentences identifying the primary improvement opportunity — use neutral, diagnostic language]

RECOMMENDED NEXT STEPS:
1. [PRIORITY 1] [Action] — [Expected benefit]
2. [PRIORITY 2] [Action] — [Expected benefit]
3. [PRIORITY 3] [Action] — [Expected benefit]
---
