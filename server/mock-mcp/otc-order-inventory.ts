...
const FULFILLMENT_OPTIONS = [
  {
    ...
    recommended: true,
    warehouses: ["WH-CHI"],
    coverage: "13/13 turbine units from Chicago DC (2 waves)",
    wave1: { units: 7, shipDate: "2026-05-02", deliveryDate: "2026-05-02" },
    ...
    csatPrediction: 0.87,
    notes: "Two ground shipments from Chicago DC. All 13 units available; 7 units ship May 2, 6 units May 3. Meets RUSH deadline. Customer preference: 87% split-ship acceptance rate.",
    checkId: "VAL-003",
    newStatus: "PASS",
  },
  {
    ...
    recommended: false,
    warehouses: ["WH-CHI"],
    coverage: "13/13 turbine units from Chicago DC (1 wave)",
    wave1: null,
    wave2: null,
    ...
    csatPrediction: 0.74,
    notes: "Single consolidated shipment after all 13 units staged. Lower carbon footprint but 3-day later delivery vs Option A. Misses RUSH delivery window by 2 days.",
    checkId: "VAL-003",
    newStatus: "WARN",
  },
  {
    ...
    recommended: false,
    warehouses: ["WH-CHI"],
    coverage: "13/13 turbine units via air freight",
    wave1: null,
    wave2: null,
...
export const toolManifest = [
  {
    ...
    description: "Returns SKU-level inventory for ORD-2026-78432. Chicago DC: TX-7250-A ×8, TX-7250-B ×4 avail (6 on-hand), TX-7300-HD ×1, CE-CX450-ENH ×2 avail. Atlanta: TX-7250-A ×4 surplus (not needed). ERP split-ship flag for TX-7250-A is a false positive — Chicago fully covers all 13 turbine units.",
