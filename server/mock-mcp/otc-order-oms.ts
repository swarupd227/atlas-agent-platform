...
const ORDER = {
  ...
  shipToIssue: {
    ...
    recommendation: "Remove 'Suite 110' — industrial facility confirmed via 8 prior delivery records (2022–2026). Astra Agents confidence: 94%.",
  },
  internalRef: "NVT-OMS-2026-78432",
  createdBy: "Astra Agents OTC-AGT-002",
  salesRep: "Sarah Chen",
  territory: "Midwest",
};
...
router.post("/release", (_req: Request, res: Response) => {
  res.json({
    ...
    releasedBy: "Astra Agents OTC-AGT-002 (automated — all holds cleared)",
