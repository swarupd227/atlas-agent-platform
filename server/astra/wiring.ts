...
export const ASTRA_TOOLS: AstraTool[] = [finishTurnTool, listAgentsTool, getAgentTool, findConnectorsTool, getIndustryContextTool, attachConnectorTool, runAgentTool, getRunTool, decideApprovalTool, discoverOutcomeTool, listOutcomesTool, createOutcomeTool, listNeedsMeTool, proposeTeamTool, buildTeamTool];
