...
export const AAR_MODULES = [
  ...
  },
  {
    ...
    icon: "Database",
    responsibility: "Capture, hash-chain, queue, and stream provenance events to Astra Agents Telemetry Collector.",
    interfaces: ["gRPC stream (Astra Agents Collector)", "Local WAL (offline queue)"],
  },
  {
    ...
    interfaces: ["OTLP/gRPC (Astra Agents Collector)", "OTLP/HTTP (customer observability, optional)"],
  },
  {
...
export const AAR_GOROUTINES = [
  ...
  },
  {
    id: "policy-sync",
    name: "Policy Sync",
    role: "Long-lived gRPC stream to Astra Agents Control Plane for policy updates",
    timingSpec: null,
