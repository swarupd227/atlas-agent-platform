  ...
  await db.insert(agentTemplates).values([
    {
      ...
      description: "Autonomous tier-1 support agent that classifies tickets, searches knowledge base, and routes or resolves issues. Handles multi-channel inquiries with intelligent routing and automated resolution for common issues.",
      category: "support",
      industry: "technology",
      tags: ["customer-service", "ticketing", "nlp", "knowledge-base", "auto-routing"],
      icon: "headphones",
      complexity: "high",
      modelProvider: "openai",
      modelName: "gpt-4.1",
    ...
    },
    {
      ...
      description: "Extract structured data from invoices, receipts, and contracts using vision + NLP. Supports multi-format documents with high-accuracy field extraction and schema validation.",
      category: "data_processing",
      industry: "financial_services",
      tags: ["ocr", "document-processing", "structured-extraction", "invoices", "contracts"],
      icon: "file-text",
      complexity: "medium",
      modelProvider: "openai",
      modelName: "gpt-4.1",
    ...
    },
    {
      ...
      description: "Score and qualify inbound leads using firmographic data, engagement signals, and predictive models. Integrates with CRM systems for real-time lead prioritization and automated follow-up triggers.",
      category: "sales",
      industry: "technology",
      tags: ["lead-scoring", "crm", "predictive-analytics", "sales-automation", "firmographic"],
      icon: "trending-up",
      complexity: "medium",
      modelProvider: "openai",
      modelName: "gpt-4.1",
    ...
    {
      name: "Content Moderator",
      description: "Real-time content moderation for UGC platforms with multi-modal analysis. Detects policy violations in text and images with configurable severity thresholds and appeal workflows.",
      category: "trust_safety",
      industry: "media_entertainment",
      tags: ["content-moderation", "multi-modal", "trust-safety", "ugc", "policy-enforcement"],
      icon: "shield",
      complexity: "high",
      modelProvider: "openai",
      modelName: "gpt-4.1",
    ...
    {
      name: "Knowledge Base Updater",
      description: "Automatically maintain and update knowledge bases from source documents and feedback loops. Ingests new content, chunks and embeds documents, and keeps search indices current with minimal human oversight.",
      category: "knowledge_management",
      industry: "cross_industry",
      tags: ["knowledge-base", "embeddings", "rag", "document-management", "search-index"],
      icon: "book-open",
      complexity: "low",
      modelProvider: "openai",
      modelName: "gpt-4.1",
    ...
    },
    {
      ...
      description: "Continuous compliance monitoring agent that checks regulatory requirements and flags violations. Scans transactions and operations against regulatory databases with audit trail and expert escalation.",
      category: "governance",
      industry: "financial_services",
      tags: ["compliance", "regulatory", "audit-trail", "risk-management", "monitoring"],
      icon: "scale",
      complexity: "high",
      modelProvider: "openai",
      modelName: "gpt-4.1",
