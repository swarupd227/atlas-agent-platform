...
async function seedNBADecisionAgent(): Promise<void> {
  ...
  const brandAiGroups: Record<string, any[]> = {
    cosmo: [
      ...
      { label: "Email from a different Hearst brand", count: 85000, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 172900, type: "hold", color: "#F97316" },
    ],
    elle: [
      ...
      { label: "Email from a different Hearst brand", count: 71400, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 116160, type: "hold", color: "#F97316" },
    ],
    goodhousekeeping: [
      ...
      { label: "Email from a different Hearst brand", count: 88000, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 129600, type: "hold", color: "#F97316" },
    ],
    harpersbazaar: [
      ...
      { label: "Email from a different Hearst brand", count: 51000, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 167600, type: "hold", color: "#F97316" },
    ],
    menshealth: [
      ...
      { label: "Email from a different Hearst brand", count: 64000, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 192800, type: "hold", color: "#F97316" },
    ],
    countryliving: [
      ...
      { label: "Email from a different Hearst brand", count: 79040, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 256300, type: "hold", color: "#F97316" },
    ],
    runnersworld: [
      ...
      { label: "Email from a different Hearst brand", count: 37800, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 65340, type: "hold", color: "#F97316" },
    ],
    esquire: [
      ...
      { label: "Email from a different Hearst brand", count: 32680, type: "cross-brand", color: "#22C55E" },
      { label: "HOLD — suppressed today", count: 104080, type: "hold", color: "#F97316" },
    ],
  };
