...
export const HNP_SUB_ONTOLOGY_CONCEPTS = [
  ...
  { label: "Offer Authority Boundary",              category: "governance_policy",  description: "Astra Agents policy requiring subscription operations sign-off before any price discount, free extension, or offer activation is executed. Prevents unilateral AI-driven pricing decisions.", synonyms: ["offer boundary", "pricing policy"] },
