...
export default function AdvSupportS4Escalation({ state }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      ...
      {/* Idle placeholder — gate content until SUP-004 starts */}
      {isIdle ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="rounded-lg border border-border/40 bg-card/50 p-4" data-testid="salesforce-case">
              ...
              {isDone ? (
                ...
                <div className="text-xs text-muted-foreground/40 italic animate-pulse">Packaging escalation…</div>
              )}
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-lg border border-border/40 bg-card/50 p-4" data-testid="t2-routing">
                ...
                {isDone ? (
                  ...
                  <div className="text-xs text-muted-foreground/40 italic animate-pulse">Identifying specialist…</div>
                )}
              </div>
              ...
              <div className="rounded-lg border border-border/40 bg-card/50 p-4" data-testid="am-notification">
                ...
                {isDone ? (
                  ...
                  <div className="text-xs text-muted-foreground/40 italic animate-pulse">Notifying account manager…</div>
                )}
              </div>
            </div>
          </div>
