import { Search, BookOpen, CheckCircle, XCircle, AlertCircle, FileText, CheckCircle2 } from "lucide-react";
...
export default function AdvSupportS2Resolution({ state }: Props) {
  const isIdle    = state.phase === "idle" || (state.phase === "triage" && state.agents.find(a => a.code === "SUP-002")?.status === "idle");
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 grid grid-cols-3 gap-2">
              {[
                ...
                { label: "Pipeline Time",   value: "SUP-001+002",   color: "text-muted-foreground" },
              ].map(m => (
