import {
  packScorers, packRegulatoryTemplates, packKpiDimensions,
  packRegressionImpactTemplates, packProductionEdgeCases, packIndustryLabels,
...
const builtIn_industryScorers: IndustryScorer[] = [
...
const builtIn_regulatoryTemplates: RegulatoryTemplate[] = [
...
const builtIn_kpiDimensions: KpiDimension[] = [
...
const builtIn_regressionImpactTemplates: RegressionImpactTemplate[] = [
...
const builtIn_productionEdgeCases: ProductionEdgeCase[] = [
...
// ── Built-ins merged with every industry pack ────────────────────────────────
export const industryLabels: Record<string, string> = { ...builtInLabels, ...packIndustryLabels };
export const industryScorers: IndustryScorer[] = [...builtIn_industryScorers, ...packScorers];
export const regulatoryTemplates: RegulatoryTemplate[] = [...builtIn_regulatoryTemplates, ...packRegulatoryTemplates];
export const kpiDimensions: KpiDimension[] = [...builtIn_kpiDimensions, ...packKpiDimensions];
export const regressionImpactTemplates: RegressionImpactTemplate[] = [...builtIn_regressionImpactTemplates, ...packRegressionImpactTemplates];
export const productionEdgeCases: ProductionEdgeCase[] = [...builtIn_productionEdgeCases, ...packProductionEdgeCases];
