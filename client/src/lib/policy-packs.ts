...
const BUILT_IN_POLICY_PACKS: PolicyPack[] = [
  {
    id: "hipaa-pack",
...
/** Built-ins plus every pack-supplied policy pack. */
export const POLICY_PACKS: PolicyPack[] = [...BUILT_IN_POLICY_PACKS, ...(packPolicyPacks as PolicyPack[])];
