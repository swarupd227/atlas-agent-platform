...
export const ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    icon: Target,
    allowedRoutes: ["/dashboard", "/outcomes", "/agents", "/journeys", "/knowledge-bases", "/monitor", "/approvals", "/billing", "/my-actions", "/actions", "/business-settings"],
  },
  {
    id: "agent_engineer",
  ...
  },
  {
    ...
    icon: Activity,
    allowedRoutes: ["/dashboard", "/deployments", "/shadow-replay", "/canary-deployment", "/healing-operations", "/runbook-automation", "/monitor", "/observability", "/agents", "/journeys", "/optimization", "/improvements", "/improvement-loop", "/integrations", "/governance", "/autonomy-engine", "/oversight-console"],
  },
  {
    ...
    icon: Shield,
    allowedRoutes: ["/dashboard", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail", "/approvals", "/admin", "/agents", "/journeys", "/deployments", "/monitor", "/observability", "/ontology"],
  },
  {
    id: "expert_validator",
    ...
    icon: UserCheck,
    allowedRoutes: ["/dashboard", "/approvals", "/agents", "/journeys", "/deployments", "/monitor", "/observability", "/evals", "/golden-datasets", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail"],
  },
  {
    id: "finance",
    label: "Finance",
