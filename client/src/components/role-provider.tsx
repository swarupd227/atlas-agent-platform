...
export const ROLES: RoleDefinition[] = [
  {
    ...
    icon: ShieldCheck,
    allowedRoutes: ["/dashboard", "/outcomes", "/agents", "/templates", "/blueprints", "/evals", "/golden-datasets", "/deployments", "/shadow-replay", "/canary-deployment", "/monitor", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail", "/approvals", "/billing", "/optimization", "/improvements", "/improvement-loop", "/integrations", "/admin", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    id: "outcome_owner",
    label: "Outcome Owner",
    ...
    icon: Target,
    allowedRoutes: ["/dashboard", "/outcomes", "/billing", "/approvals", "/agents", "/monitor", "/golden-datasets", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    id: "agent_engineer",
    ...
    icon: Bot,
    allowedRoutes: ["/dashboard", "/agents", "/templates", "/blueprints", "/evals", "/golden-datasets", "/optimization", "/improvements", "/improvement-loop", "/outcomes", "/integrations", "/deployments", "/shadow-replay", "/canary-deployment", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph", "/autonomy-engine", "/oversight-console"],
  },
  {
    id: "ops_sre",
    label: "Ops / SRE",
    ...
    icon: Activity,
    allowedRoutes: ["/dashboard", "/deployments", "/shadow-replay", "/canary-deployment", "/monitor", "/agents", "/optimization", "/improvements", "/improvement-loop", "/integrations", "/governance", "/autonomy-engine", "/oversight-console", "/golden-datasets", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    ...
    icon: Shield,
    allowedRoutes: ["/dashboard", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail", "/approvals", "/admin", "/agents", "/deployments", "/shadow-replay", "/canary-deployment", "/monitor", "/golden-datasets", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    id: "expert_validator",
    ...
    icon: UserCheck,
    allowedRoutes: ["/dashboard", "/approvals", "/agents", "/deployments", "/shadow-replay", "/canary-deployment", "/evals", "/golden-datasets", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    id: "finance",
    label: "Finance",
