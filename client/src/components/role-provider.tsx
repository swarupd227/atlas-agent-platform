...
export const ROLES: RoleDefinition[] = [
  ...
  },
  {
    ...
    icon: Activity,
    allowedRoutes: ["/dashboard", "/deployments", "/shadow-replay", "/canary-deployment", "/healing-operations", "/runbook-automation", "/monitor", "/agents", "/optimization", "/improvements", "/improvement-loop", "/integrations", "/governance", "/autonomy-engine", "/oversight-console", "/golden-datasets", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    ...
    icon: Shield,
    allowedRoutes: ["/dashboard", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail", "/approvals", "/admin", "/agents", "/deployments", "/shadow-replay", "/canary-deployment", "/healing-operations", "/runbook-automation", "/monitor", "/golden-datasets", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    id: "expert_validator",
    ...
    icon: UserCheck,
    allowedRoutes: ["/dashboard", "/approvals", "/agents", "/deployments", "/shadow-replay", "/canary-deployment", "/healing-operations", "/runbook-automation", "/evals", "/golden-datasets", "/governance", "/autonomy-engine", "/oversight-console", "/audit-trail", "/ontology", "/skills", "/context-studio", "/memory-architecture", "/rag-pipeline", "/knowledge-graph"],
  },
  {
    id: "finance",
    label: "Finance",
